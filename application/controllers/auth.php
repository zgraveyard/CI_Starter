...
class Auth extends MY_Controller {
    ...
    function index() {
        ...
        if (!$this->ion_auth->logged_in()) {
            ...
            $this->load->view('themes/' . $this->theme . '/auth/index', $this->data);
        }
    }
    ...
    function change_password() {
        ...
        if ($this->form_validation->run() == false) { //display the form
            ...
            //render
            $this->load->view('themes/' . $this->theme . '/auth/change_password', $this->data);
        } else {
    ...
    function forgot_password() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
            $this->load->view('themes/' . $this->theme . '/auth/forgot_password', $this->data);
        } else {
    ...
    function deactivate($id = NULL) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('themes/' . $this->theme . '/auth/deactivate_user', $this->data);
        } else {
    ...
    function create_user() {
        ...
        if ($this->form_validation->run() == true && $this->ion_auth->register($username, $password, $email, $additional_data)) { //check to see if we are creating the user
            ...
            $this->load->view('themes/' . $this->theme . '/auth/create_user', $this->data);
        }
    }
